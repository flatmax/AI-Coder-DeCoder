...
4. Copy text exactly from the file — whitespace, formatting, blank lines all matter. Always copy-paste from the file content in context, never type from memory
5. Never use placeholders like `...` or `// rest of content`
