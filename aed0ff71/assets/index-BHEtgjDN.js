 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ft=(i,e,t)=>{const s=new Map;for(let n=e;n<=t;n++)s.set(i[n],n);return s},bi=is(class extends ns{constructor(i){if(super(i),i.type!==ss.CHILD)throw Error("repeat() can only be used in text expressions")}dt(i,e,t){let s;t===void 0?t=e:e!==void 0&&(s=e);const n=[],r=[];let o=0;for(const a of i)n[o]=s?s(a,o):o,r[o]=t(a,o),o++;return{values:r,keys:n}}render(i,e,t){return this.dt(i,e,t).values}update(i,[e,t,s]){const n=mi(i),{values:r,keys:o}=this.dt(e,t,s);if(!Array.isArray(n))return this.ut=o,r;const a=this.ut??=[],l=[];let c,h,u=0,g=n.length-1,b=0,E=r.length-1;for(;u<=g&&b<=E;)if(n[u]===null)u++;else if(n[g]===null)g--;else if(a[u]===o[b])l[b]=K(n[u],r[b]),u++,b++;else if(a[g]===o[E])l[E]=K(n[g],r[E]),g--,E--;else if(a[u]===o[E])l[E]=K(n[u],r[E]),ce(i,l[E+1],n[u]),u++,E--;else if(a[g]===o[b])l[b]=K(n[g],r[b]),ce(i,n[u],n[g]),g--,b++;else if(c===void 0&&(c=Ft(o,b,E),h=Ft(a,u,g)),c.has(a[u]))if(c.has(a[g])){const _=h.get(o[b]),C=_!==void 0?n[_]:null;if(C===null){const M=ce(i,n[u]);K(M,r[b]),l[b]=M}else l[b]=K(C,r[b]),ce(i,n[u],C),n[_]=null;b++}else Be(n[g]),g--;else Be(n[u]),u++;for(;b<=E;){const _=ce(i,l[E+1]);K(_,r[b]),l[b++]=_}for(;u<=g;){const _=n[u++];_!==null&&Be(_)}return this.ut=o,gi(i,l),G}});class xi extends P{static properties={content:{type:String},images:{type:Array}};constructor(){super(),this.content="",this.images=[]}static styles=I`
    :host {
      display: block;
    }
...
`)}function Di(i,e){return i.map(t=>{const s=O(t.text);return t.type==="same"?s:e==="remove"&&t.type==="remove"||e==="add"&&t.type==="add"?`<span class="diff-change">${s}</span>`:s}).join("")}function Hi(i,e,t){if(!e||e.length===0)return{html:i,foundFiles:[]};let s=i;const n=[],r=[...e].sort((o,a)=>a.length-o.length);for(const o of r){const a=o.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),l=new RegExp(`(?<!<[^>]*)(?<!class=")\\b(${a})\\b(?![^<]*>)`,"g");if(l.test(i)){n.push(o);const h=t&&t.includes(o)?" in-context":"";l.lastIndex=0,s=s.replace(l,`<span class="file-mention${h}" data-file="${o}">$1</span>`)}}return{html:s,foundFiles:n}}function Oi(i,e){if(i.length===0)return"";const t=i.filter(o=>!e||!e.includes(o)),s=t.length>1,n=i.map(o=>{const a=e&&e.includes(o),l=a?"in-context":"not-in-context",c=a?"✓":"+";return`<span class="file-chip ${l}" data-file="${O(o)}"><span class="chip-icon">${c}</span>${O(o)}</span>`}).join("");return`
  ...
  `}class ji extends P{static properties={content:{type:String},role:{type:String},mentionedFiles:{type:Array},selectedFiles:{type:Array},editResults:{type:Array}};static styles=I`
    :host {
      display: block;
    }
...
`)})}let o="";for(const a of n)a.type==="text"?o+=T.parse(a.content):o+=Pi(a.block,this.editResults);return o}wrapCodeBlocksWithCopyButton(e){const t=/(<pre[^>]*>)(\s*<code[^>]*>)([\s\S]*?)(<\/code>\s*<\/pre>)/gi;return e.replace(t,(s,n,r,o,a)=>`<div class="code-wrapper">${n}${r}${o}${a}<button class="copy-btn" onclick="navigator.clipboard.writeText(this.previousElementSibling.textContent)">Copy</button></div>`)}highlightFileMentions(e){const{html:t,foundFiles:s}=Hi(e,this.mentionedFiles,this.selectedFiles);return this._foundFiles=s,t}renderEditsSummary(){return Ii(this.editResults)}renderFilesSummary(){return Oi(this._foundFiles,this.selectedFiles)}handleClick(e){const t=e.target.closest(".file-mention");if(t){const l=t.dataset.file;l&&this.dispatchEvent(new CustomEvent("file-mention-click",{detail:{path:l},bubbles:!0,composed:!0}));return}const s=e.target.closest(".edit-block-file");if(s){const l=s.dataset.file,c=s.dataset.context;if(l){const h=Ee(this.editResults,l);this.dispatchEvent(new CustomEvent("edit-block-click",{detail:{path:l,line:h?.estimated_line||1,status:h?.status||"pending",searchContext:c||null},bubbles:!0,composed:!0}))}return}const n=e.target.closest(".edit-tag");if(n){const l=n.dataset.file;if(l){const c=Ee(this.editResults,l);this.dispatchEvent(new CustomEvent("edit-block-click",{detail:{path:l,line:c?.estimated_line||1,status:c?.status||"pending",searchContext:null},bubbles:!0,composed:!0}))}return}const r=e.target.closest(".file-chip");if(r){const l=r.dataset.file;l&&this.dispatchEvent(new CustomEvent("file-mention-click",{detail:{path:l},bubbles:!0,composed:!0}));return}const o=e.target.closest(".select-all-btn");if(o){try{const l=JSON.parse(o.dataset.files||"[]");for(const c of l)this.dispatchEvent(new CustomEvent("file-mention-click",{detail:{path:c},bubbles:!0,composed:!0}))}catch(l){console.error("Failed to parse files:",l)}return}const a=e.target.closest(".edit-block");if(a){const l=a.dataset.file;if(l){const c=Ee(this.editResults,l);this.dispatchEvent(new CustomEvent("edit-block-click",{detail:{path:l,line:c?.estimated_line||1,status:c?.status||"pending",searchContext:null},bubbles:!0,composed:!0}))}return}}willUpdate(){this._codeScrollPositions.clear();const e=this.shadowRoot?.querySelectorAll("pre");e&&e.forEach((t,s)=>{t.scrollLeft>0&&this._codeScrollPositions.set(s,t.scrollLeft)})}updated(){if(this._codeScrollPositions.size>0){const e=this.shadowRoot?.querySelectorAll("pre");e&&this._codeScrollPositions.forEach((t,s)=>{e[s]&&(e[s].scrollLeft=t)})}}render(){const e=this.processContent();return d`
    ...
    `}}customElements.define("card-markdown",ji);class Bi extends P{static properties={content:{type:String},mentionedFiles:{type:Array},selectedFiles:{type:Array},editResults:{type:Array}};static styles=I`
    :host {
      display: block;
    }
  ...
  `;copyToClipboard(){navigator.clipboard.writeText(this.content)}copyToPrompt(){this.dispatchEvent(new CustomEvent("copy-to-prompt",{detail:{content:this.content},bubbles:!0,composed:!0}))}render(){return d`
    ...
    `}}customElements.define("assistant-card",Bi);class Ni extends P{static properties={isListening:{type:Boolean,state:!0},autoTranscribe:{type:Boolean,state:!0},isSupported:{type:Boolean,state:!0},ledStatus:{type:String,state:!0}};constructor(){super(),this.isListening=!1,this.autoTranscribe=!1,this.isSupported="webkitSpeechRecognition"in window||"SpeechRecognition"in window,this.ledStatus="inactive",this.recognition=null,this._initSpeechRecognition()}static styles=I`
    :host {
      display: inline-flex;
    }
  ...
  `;connectedCallback(){super.connectedCallback(),!this.recognition&&this.isSupported&&this._initSpeechRecognition()}disconnectedCallback(){if(super.disconnectedCallback(),this.recognition)try{this.recognition.stop()}catch{}}_initSpeechRecognition(){if(!this.isSupported)return;const e=window.SpeechRecognition||window.webkitSpeechRecognition;this.recognition=new e,this.recognition.continuous=!1,this.recognition.interimResults=!1,this.recognition.lang=navigator.language||"en-US",this.recognition.onstart=this._handleStart.bind(this),this.recognition.onresult=this._handleResult.bind(this),this.recognition.onerror=this._handleError.bind(this),this.recognition.onend=this._handleEnd.bind(this),this.recognition.onspeechstart=this._handleSpeechStart.bind(this),this.recognition.onspeechend=this._handleSpeechEnd.bind(this)}_handleStart(){this.isListening=!0,this.ledStatus="listening",this.dispatchEvent(new CustomEvent("recording-started",{bubbles:!0,composed:!0}))}_handleSpeechStart(){this.ledStatus="speaking"}_handleSpeechEnd(){this.autoTranscribe&&this.isListening&&(this.ledStatus="listening")}_handleResult(e){if(e.results.length>0){const t=e.results[e.resultIndex][0].transcript;this.dispatchEvent(new CustomEvent("transcript",{detail:{text:t},bubbles:!0,composed:!0})),this.autoTranscribe||this.stopListening()}}_handleError(e){console.error("Speech recognition error:",e.error),this.stopListening(),this.dispatchEvent(new CustomEvent("recognition-error",{detail:{error:e.error},bubbles:!0,composed:!0}))}_handleEnd(){this.autoTranscribe&&this.isListening?setTimeout(()=>{try{this.recognition.start()}catch(e){console.error("Error restarting recognition:",e),this.isListening=!1,this.ledStatus="inactive"}},100):(this.isListening=!1,this.ledStatus="inactive")}startListening(){if(!(!this.isSupported||this.isListening))try{this.recognition.start()}catch(e){console.error("Error starting recognition:",e)}}stopListening(){if(!(!this.isSupported||!this.isListening))try{this.recognition.stop()}catch(e){console.error("Error stopping recognition:",e),this.isListening=!1,this.ledStatus="inactive"}}_toggleListening(){this.isListening?this.stopListening():this.startListening()}_toggleAutoTranscribe(){this.autoTranscribe=!this.autoTranscribe,this.autoTranscribe?this.startListening():this.stopListening()}render(){if(!this.isSupported)return d``;const e=this.ledStatus==="speaking"?"speaking":this.isListening?"listening":"";return d`
      ...
      >🎤</button>
    `}}customElements.define("speech-to-text",Ni);const qi=I`
  :host {
    display: flex;
    flex-direction: column;
    font-size: 13px;
...
`;function Vi(i){return d`
  ...
  `}function Wi(i){return i.isSearching?d`
      <div class="loading">
  ...
  `}function Gi(i,e,t,s){if(!e)return i;try{const n=s?"gi":"g",r=t?e:e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),o=new RegExp(`(${r})`,n);return i.split(o).map((l,c)=>c%2===1?d`<span class="highlight">${l}</span>`:l)}catch{return i}}function Pt(i,e){return!i||i.length===0?"":d`
    ${i.map(t=>d`
    ...
    `)}
  `}function Xi(i,e,t,s){const n=i.focusedIndex===s,r=i.hoveredIndex===s,o=n||r,a=t.context_before?.length>0||t.context_after?.length>0;return d`
    <div 
    ...
    >
      ...
      <div class="match-line">
        ...
        <span class="match-content">
          ${Gi(t.line,i.query,i.useRegex,i.ignoreCase)}
        </span>
      </div>
      ${a?d`
        <div class="context-lines">
  ...
  `}function Yi(i){if(i.results.length===0)return Wi(i);let e=0;return d`
    ${i.results.map(t=>{const s=t.matches.map(n=>{const r=Xi(i,t,n,e);return e++,r});return d`
      ...
      `})}
  `}function Zi(i){return i.reduce((e,t)=>e+t.matches.length,0)}function Ki(i){const e=Zi(i.results),t=i.results.length;return d`
    <div class="container">
...
`;function en(i){return d`
  ...
  `}function tn(i){const{breakdown:e}=i;if(!e)return d``;const t=i.getUsagePercent(),s=t>90?"danger":t>75?"warning":"";return d`
  ...
  `}function de(i,e,t,s=!1){const n=i.expandedSections[e],r=i.getBarWidth(t.tokens);return d`
    ...
    ${s&&n?sn(i,e,t):""}
  `}function sn(i,e,t){if(e==="files"&&t.items?.length)return d`
    ...
    `:""}function nn(i){const{breakdown:e}=i;if(!e?.breakdown)return d``;const t=e.breakdown,s=t.symbol_map?.files?.length>0;return d`
  ...
  `}function rn(i){return i.isLoading&&!i.breakdown?d`<div class="loading">Loading context breakdown...</div>`:i.error?d`<div class="error">Error: ${i.error}</div>`:i.breakdown?d`
...
`;class ze extends P{static properties={open:{type:Boolean}};constructor(){super(),this.open=!1}_close(){this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}_handleOverlayClick(e){e.target===e.currentTarget&&this._close()}_copyToClipboard(e){e&&navigator.clipboard.writeText(e)}}class on extends ze{static properties={...ze.properties,url:{type:String},content:{type:Object},showFullContent:{type:Boolean}};static styles=[cs,I`
      .modal {
        width: 90%;
        max-width: 800px;
        max-height: 80vh;
    ...
    `}}customElements.define("url-content-modal",on);class an extends ze{static properties={...ze.properties,content:{type:String},isLoading:{type:Boolean}};static styles=[cs,I`
      .modal {
        width: 90%;
        max-width: 900px;
        max-height: 85vh;
...
`).length:0}render(){return this.open?d`
    ...
    `:d``}}customElements.define("symbol-map-modal",an);class ln extends Le(be(P)){static properties={visible:{type:Boolean},expandedSections:{type:Object},...Le.mixinProperties};static styles=Ji;constructor(){super(),this.visible=!0,this.expandedSections={files:!1,urls:!1,history:!1,symbol_map:!1},this.initViewerData()}onRpcReady(){this.refreshBreakdown()}willUpdate(e){this._viewerDataWillUpdate(e)}toggleSection(e){this.expandedSections={...this.expandedSections,[e]:!this.expandedSections[e]}}getUsagePercent(){if(!this.breakdown)return 0;const{used_tokens:e,max_input_tokens:t}=this.breakdown;return t?Math.min(100,Math.round(e/t*100)):0}getBarWidth(e){return!this.breakdown||!this.breakdown.used_tokens?0:Math.round(e/this.breakdown.used_tokens*100)}render(){return rn(this)}}customElements.define("context-viewer",ln);const cn=I`
  :host {
    display: block;
    height: 100%;
    width: 100%;
...
`;function ct(i){if(i.length>40){const e=i.split("/");if(e.length>3)return`${e[0]}/.../${e.slice(-2).join("/")}`}return i}function dn(i){return i.next_threshold?`${i.stable_count}/${i.next_threshold}`:""}function It(i){return d`
  ...
  `}function ds(i,e){if(!i.next_threshold)return d`
    ...
    <div class="stability-container">
      ...
      <span class="stability-text">${dn(i)}</span>
    </div>
  `}function hn(i,e,t,s){const{type:n,icon:r,label:o}=s,a=i.isGroupExpanded(e,n),l=i.filterItems(t.items,n),c=l?.length||0,h=t.items?.length||t.count||0;if(i.searchQuery&&c===0)return"";const u=i.searchQuery?`${c}/${h}`:h;return d`
    <div class="content-group">
      ...
      ${a?d`
        <div class="item-list">
          ${(l||[]).map(b=>s.renderItem?s.renderItem(i,b,e):un(i,b,e))}
        </div>
      `:""}
    </div>
  `}function un(i,e,t){return d`
    <div class="item-row clickable" @click=${()=>i.viewFile(e.path)}>
      <span class="item-path" title="${e.path}">${ct(e.path)}</span>
      ${ds(e,t)}
    </div>
  `}function pn(i,e,t){return d`
    <div class="item-row clickable" @click=${()=>i.viewFile(e.path)}>
      <span class="item-path" title="${e.path}">${ct(e.path)}</span>
      <span class="item-tokens">${S(e.tokens)}</span>
      ${ds(e,t)}
    </div>
  `}function fn(i,e,t){const s=i.isUrlIncluded(e.url);return d`
    <div class="url-row">
      <input 
        type="checkbox" 
        class="url-checkbox"
  ...
  `}const gn={symbols:{type:"symbols",icon:"📦",label:"Symbols",renderItem:null},files:{type:"files",icon:"📄",label:"Files",renderItem:pn},urls:{type:"urls",icon:"🔗",label:"URLs",renderItem:fn}};function mn(i,e,t){return d`
    <div class="content-group">
  ...
  `}function yn(i,e){const t=i.expandedTiers[e.tier],s=e.tokens===0,n=i.getTierColor(e.tier);return i.searchQuery&&!i.tierHasMatches(e)?"":d`
    <div class="tier-block ${s?"empty":""}" style="--tier-color: ${n}">
      ...
      ${t&&e.contents?.length?d`
        <div class="tier-contents">
          ${e.contents.map(r=>{switch(r.type){case"system":return bn(i,r);case"legend":return xn(i,r);case"symbols":case"files":case"urls":return hn(i,e.tier,r,gn[r.type]);case"history":return mn(i,e.tier,r);default:return""}})}
        </div>
      `:""}
    </div>
  `}function vn(i){return i.recentChanges?.length?d`
  ...
  `:""}function wn(i){const e=i.breakdown?.session_totals;return e?d`
    <div class="session-totals">
  ...
  `}function _n(i){if(i.isLoading&&!i.breakdown)return d`<div class="loading">Loading cache breakdown...</div>`;if(i.error)return d`<div class="error">Error: ${i.error}</div>`;if(!i.breakdown)return d`<div class="loading">No breakdown data available</div>`;const e=i.breakdown.blocks||[];if(e.length===0)return d`
    ...
    <div class="cache-container">
      ...
      ${t?e.map(s=>yn(i,s)):d`<div class="no-results">No items match "${i.searchQuery}"</div>`}
  ...
  `}function Cn(i){if(!i.tier_info)return"";const t=i.promotions||[],s=i.demotions||[];if(t.length===0&&s.length===0)return"";const n=r=>{const o=r.replace("symbol:","📦 "),a=o.split("/");return a.length>2?"..."+a.slice(-2).join("/"):o};return d`
    <div class="hud-divider"></div>
    ...
    `:""}
  `}function En(i){if(!i._hudVisible||!i._hudData)return"";const e=i._hudData,t=e.prompt_tokens||0,s=e.cache_hit_tokens||0,n=t>0?Math.round(s/t*100):0;return d`
  ...
  `}function Fn(i){const e=i.detectedUrls?.length>0,t=Object.keys(i.fetchedUrls||{}).length>0,s=Object.keys(i.fetchingUrls||{}).length>0;return!e&&!t&&!s?"":d`
  ...
  `}function Tn(i){const e=i._hudData?.history_tokens||0,t=i._hudData?.history_threshold||9e3;if(t<=0)return"";const s=Math.min(100,e/t*100),n=s>95?"critical":s>80?"warning":"";return d`
    <div class="history-bar ${n}" title="History: ${S(e)} / ${S(t)} (${Math.round(s)}%)">
      <div class="history-bar-fill" style="width: ${s}%"></div>
    </div>
  `}function An(i){return!i.promptSnippets||i.promptSnippets.length===0?"":d`
  ...
  `}function Rn(i){return i.minimized?"":d`
  ...
  `}function Mn(i){const e=i.dialogX!==null&&i.dialogY!==null,t=e?`left: ${i.dialogX}px; top: ${i.dialogY}px;`:"",s=i.getResizeStyle?i.getResizeStyle():"",n=[t,s].filter(Boolean).join("; ");return d`
    ${En(i)}
    <history-browser
...
`;function Gn(i){return i.isSearching&&i.searchResults.length>0?d`
  ...
  `)}function Xn(i){return i.selectedSessionId?i.isLoading?d`<div class="loading">Loading...</div>`:i.selectedSession.length===0?d`
      <div class="empty-state">
        <div class="icon">📭</div>
  ...
  `):d`
    ...
    `}function Yn(i){return i.visible?d`
...
`;function Qn(i){return i.message?d`
    <div 
  ...
  `:""}function Jn(i){const e=i.configInfo?.model||"Loading...",t=i.configInfo?.smaller_model||"Loading...";return d`
    <div class="section">
...
`+e:this.inputValue+=e,this.updateComplete.then(()=>{const t=this.shadowRoot?.querySelector("textarea");t&&(t.focus(),t.selectionStart=t.selectionEnd=t.value.length,this._autoResizeTextarea(t))})}toggleLeftPanel(){this.leftPanelCollapsed=!this.leftPanelCollapsed,localStorage.setItem("promptview-left-panel-collapsed",this.leftPanelCollapsed)}_handlePanelResizeStart(e){e.preventDefault(),this._isPanelResizing=!0,this._panelResizeStartX=e.clientX,this._panelResizeStartWidth=this.leftPanelWidth,window.addEventListener("mousemove",this._boundPanelResizeMove),window.addEventListener("mouseup",this._boundPanelResizeEnd)}_handlePanelResizeMove(e){if(!this._isPanelResizing)return;const t=e.clientX-this._panelResizeStartX,s=Math.max(150,Math.min(500,this._panelResizeStartWidth+t));this.leftPanelWidth=s}_handlePanelResizeEnd(){this._isPanelResizing&&(this._isPanelResizing=!1,localStorage.setItem("promptview-left-panel-width",this.leftPanelWidth),window.removeEventListener("mousemove",this._boundPanelResizeMove),window.removeEventListener("mouseup",this._boundPanelResizeEnd))}async loadLastSession(){try{const e=await this.call["LiteLLM.history_list_sessions"](1),t=this.extractResponse(e);if(t&&t.length>0){const s=t[0].session_id,n=await this.call["LiteLLM.load_session_into_context"](s),r=this.extractResponse(n);if(r&&r.length>0){for(const o of r)this.addMessage(o.role,o.content,o.images||null,o.edit_results||null);this.scrollToBottomNow()}}await this._refreshHistoryBar()}catch(e){console.warn("Could not load last session:",e),console.error(e)}}remoteDisconnected(e){this.isConnected=!1}extractResponse(e){return lt(e)}streamChunk(e,t){try{return super.streamChunk(e,t),!0}catch(s){return console.error("streamChunk error:",s),!1}}streamComplete(e,t){return Promise.resolve().then(async()=>{try{await super.streamComplete(e,t)}catch(s){console.error("streamComplete async error:",s)}}),!0}compactionEvent(e,t){try{return super.compactionEvent(e,t),!0}catch(s){return console.error("compactionEvent error:",s),!1}}render(){return Mn(this)}}customElements.define("prompt-view",or);class ar extends P{static properties={diffFiles:{type:Array},showDiff:{type:Boolean},serverURI:{type:String},viewingFile:{type:String},showUrlModal:{type:Boolean},urlModalContent:{type:Object}};static styles=I`
  ...
  `;constructor(){super(),this.diffFiles=[],this.showDiff=!1,this.viewingFile=null,this.showUrlModal=!1,this.urlModalContent=null;const t=new URLSearchParams(window.location.search).get("port")||"8765";this.serverURI=`ws://localhost:${t}`,this._handleKeydown=this._handleKeydown.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._handleKeydown),this._updateTitle()}async _updateTitle(){await this.updateComplete;const e=this.shadowRoot?.querySelector("prompt-view");if(!e){console.warn("_updateTitle: prompt-view not found");return}let t=0;const s=50,n=setInterval(async()=>{if(t++,t>s){clearInterval(n),console.warn("_updateTitle: timed out waiting for RPC");return}if(e.call&&typeof e.call["Repo.get_repo_name"]=="function"){clearInterval(n);try{const r=await e.call["Repo.get_repo_name"](),o=r?Object.values(r)[0]:null;o?document.title=o:console.warn("_updateTitle: empty repo name response",r)}catch(r){console.error("Failed to get repo name:",r)}}},100)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._handleKeydown)}_handleKeydown(e){if(e.ctrlKey&&e.shiftKey&&e.key==="F"){e.preventDefault();const t=this.shadowRoot?.querySelector("prompt-view");t&&t.switchTab(R.SEARCH)}if(e.ctrlKey&&e.key==="b"){e.preventDefault();const t=this.shadowRoot?.querySelector("prompt-view");t&&t.switchTab(R.FILES)}}async _loadFileIntoDiff(e,t=!0){const s=t!==!1;if(this.diffFiles.find(o=>o.path===e)&&!s)return!0;const r=this.shadowRoot.querySelector("prompt-view");if(!r?.call)return!1;try{const o=await r.call["Repo.get_file_content"](e),a=o?Object.values(o)[0]:null,l=typeof a=="string"?a:a?.content??null;if(l!==null){const c={path:e,original:l,modified:l,isNew:!1,isReadOnly:!0};return s?this.diffFiles=[c]:this.diffFiles=[...this.diffFiles,c],!0}}catch(o){console.error("Failed to load file:",o)}return!1}async handleSearchResultSelected(e){const{file:t,line:s}=e.detail;this.viewingFile=t,this.activeLeftTab="files",await this._loadFileIntoDiff(t),await this.updateComplete;const n=this.shadowRoot.querySelector("diff-viewer");n&&setTimeout(()=>{n.selectFile(t),setTimeout(()=>{n._revealPosition(s,1)},150)},100)}async handleSearchFileSelected(e){const{file:t}=e.detail;this.viewingFile=t,await this._loadFileIntoDiff(t)}handleCloseSearch(){this.activeLeftTab="files"}handleFileSelected(e){this.viewingFile=e.detail.path}handleEditsApplied(e){const{files:t}=e.detail;t&&t.length>0&&(this.diffFiles=t,this.showDiff=!0)}async handleFilesEdited(e){const{paths:t}=e.detail;if(!t||t.length===0)return;const s=this.shadowRoot.querySelector("diff-viewer");if(!s)return;const n=s.getOpenFilePaths();if(n.length===0)return;const r=new Set(t),o=n.filter(l=>r.has(l));if(o.length===0)return;const a=this.shadowRoot.querySelector("prompt-view");if(a?.call)for(const l of o)try{const c=await a.call["Repo.get_file_content"](l,"HEAD"),h=c?Object.values(c)[0]:null,u=typeof h=="string"?h:h?.content??"",g=await a.call["Repo.get_file_content"](l),b=g?Object.values(g)[0]:null,E=typeof b=="string"?b:b?.content??"";s.refreshFileContent(l,u,E)}catch(c){console.error("Failed to refresh file:",l,c)}}async handleNavigateToEdit(e){const{path:t,line:s,searchContext:n,status:r}=e.detail;this.viewingFile=t;const o=this.diffFiles.find(c=>c.path===t);o&&o.original!==o.modified||(r==="applied"?await this._loadDiffFromHead(t)||await this._loadFileIntoDiff(t):o||await this._loadFileIntoDiff(t)),await this.updateComplete;const l=this.shadowRoot.querySelector("diff-viewer");l&&setTimeout(()=>{l.selectFile(t),setTimeout(()=>{const c=n&&l._findLineByContent(n)||s;c&&l._revealPosition(c,1)},150)},100)}async _loadDiffFromHead(e){const t=this.shadowRoot.querySelector("prompt-view");if(!t?.call)return!1;try{const s=await t.call["Repo.get_file_content"](e,"HEAD"),n=s?Object.values(s)[0]:null,r=typeof n=="string"?n:n?.content??null,o=await t.call["Repo.get_file_content"](e),a=o?Object.values(o)[0]:null,l=typeof a=="string"?a:a?.content??null;return r===null||l===null||r===l?!1:(this.diffFiles=[{path:e,original:r,modified:l,isNew:!1,isReadOnly:!1}],!0)}catch(s){return console.error("Failed to load diff from HEAD:",s),!1}}clearDiff(){this.diffFiles=[],this.showDiff=!1;const e=this.shadowRoot.querySelector("diff-viewer");e&&e.clearFiles()}async handleRequestFileLoad(e){const{file:t,line:s,column:n,replace:r}=e.detail;if(await this._loadFileIntoDiff(t,r)&&(s||n)){await this.updateComplete;const a=this.shadowRoot.querySelector("diff-viewer");a&&setTimeout(()=>{a.selectFile(t),s&&setTimeout(()=>{a._revealPosition(s,n||1)},150)},100)}}handleRemoveUrl(e){const{url:t}=e.detail,s=this.shadowRoot?.querySelector("prompt-view");if(s&&s.fetchedUrls){const{[t]:n,...r}=s.fetchedUrls;s.fetchedUrls=r,this._refreshContextViewer()}}handleUrlRemoved(e){this._refreshContextViewer()}handleViewUrlContent(e){const{content:t}=e.detail;this.urlModalContent=t,this.showUrlModal=!0}closeUrlModal(){this.showUrlModal=!1,this.urlModalContent=null}async handleConfigEditRequest(e){const{configType:t}=e.detail,s=this.shadowRoot.querySelector("prompt-view");if(!s?.call){console.error("RPC not available for config edit");return}try{const n=await s.call["Settings.get_config_content"](t),r=n?Object.values(n)[0]:null;if(!r?.success){console.error("Failed to load config:",r?.error);return}const o=`[config]/${t}`;this.diffFiles=[{path:o,original:r.content,modified:r.content,isNew:!1,isReadOnly:!1,isConfig:!0,configType:t,realPath:r.path}],this.viewingFile=o}catch(n){console.error("Failed to load config for editing:",n)}}async handleFileSave(e){const{path:t,content:s,isConfig:n,configType:r}=e.detail,o=this.shadowRoot.querySelector("prompt-view");if(!o?.call){console.error("RPC not available for file save");return}try{if(n&&r){const a=await o.call["Settings.save_config_content"](r,s),l=a?Object.values(a)[0]:null;l?.success||console.error("Failed to save config:",l?.error)}else await o.call["Repo.write_file"](t,s)}catch(a){console.error("Failed to save file:",a)}}async handleFilesSave(e){const{files:t}=e.detail,s=this.shadowRoot.querySelector("prompt-view");if(!s?.call){console.error("RPC not available for file save");return}for(const n of t)try{if(n.isConfig&&n.configType){const r=await s.call["Settings.save_config_content"](n.configType,n.content),o=r?Object.values(r)[0]:null;o?.success||console.error("Failed to save config:",o?.error)}else await s.call["Repo.write_file"](n.path,n.content)}catch(r){console.error("Failed to save file:",n.path,r)}}render(){return d`
    ...
    `}}customElements.define("app-shell",ar);
